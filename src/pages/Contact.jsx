        ...
        <div className='py-26 text-white flex flex-col items-center gap-10'>
            ...
            <form ref={refForm} action="" onSubmit={handleSubmit} className='flex flex-col gap-10 text-left w-[90%] lg:w-full '>
                ...
                <div className='flex flex-col gap-2 w-full'>
                    ...
                    <input required name='subject' type="text" placeholder='Let me know how can i help you ' className='border-1 border-white rounded-md px-7 py-2 w-full' />
                </div>
                <div className='flex flex-col gap-2 w-full'>
                    <label htmlFor="">Leave a comment </label>
                    <textarea required name='message' maxLength={500} type="text" placeholder='Your@emailhere.com' className='border-1 border-white rounded-md px-7 py-2 w-full' rows={5} cols={30} />
                </div>

                

                <div className='w-full justify-center flex items-center'>
                    <button className='flex flex-row items-center gap-2 w-50 lg:w-50 justify-center border-1 border-white px-4 py-2 rounded-lg hover:border-blue-500 hover:text-blue-500 hover:scale-104 group transition duration-150'>
                        Send Message
